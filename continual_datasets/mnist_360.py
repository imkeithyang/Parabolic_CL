...
from continual_datasets.perm_mnist import MyMNIST
from continual_datasets.transforms.rotation import IncrementalRotation
from continual_datasets.utils.gcl_dataset import GCLDataset
